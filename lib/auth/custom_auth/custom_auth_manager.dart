...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    jetCopyAuthUserSubject.add(
      JetCopyAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<JetCopyAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  JetCopyAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = JetCopyAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    jetCopyAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
